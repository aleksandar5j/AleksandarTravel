...
@WebServlet(name = "AdminDodajObjekat", urlPatterns = {"/api/admindodajobjekat"})
public class AdminDodajObjekat extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int des_id = params.getInt("des_id");
            ...
            var res = Main.db.execute("INSERT INTO objekti (des_id, obj_naziv, obj_adresa, obj_telefon, obj_brojzvezdica, obj_opis) "
                    + "VALUES (?, ?, ?, ?, ?, ?)", 
                    des_id, obj_naziv, obj_adresa, obj_telefon, obj_brojzvezdica, obj_opis);
            obj.put("res", "OK");
            obj.put("data", res);       
        }      
        catch (Exception ex) {
