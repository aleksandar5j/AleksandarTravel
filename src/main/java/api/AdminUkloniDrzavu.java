...
@WebServlet(name = "AdminUkloniDrzavu", urlPatterns = {"/api/adminuklonidrzavu"})
public class AdminUkloniDrzavu extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {           
            ...
            var res = Main.db.execute("DELETE FROM drzave WHERE drz_id = ?", drz_id);             
            obj.put("res", "OK");  
            obj.put("msg", "Drzava obrisana!");
        }      
        catch (Exception ex) {
            ex.printStackTrace();
            obj.put("res", "ERR");
