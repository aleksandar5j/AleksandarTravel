...
@WebServlet(name = "DodajOmiljene", urlPatterns = {"/api/dodajomiljene"})
public class DodajOmiljene extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            var data = Main.db.execute("INSERT INTO omiljene (kor_id, des_id, obj_id) VALUES (?, ?, ?)", kor_id, des_id, obj_id);
            obj.put("res", "OK");
